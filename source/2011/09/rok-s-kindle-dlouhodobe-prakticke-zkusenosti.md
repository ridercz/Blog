<!-- dcterms:identifier = riderweblog#261 -->
<!-- dcterms:title = Rok s Kindle – dlouhodobé praktické zkušenosti -->
<!-- dcterms:abstract = Amazon včera představil několik nových variant své e-bookové čtečky Kindle. Já Kindle vlastním už zhruba rok, tak jsem se rozhodl sepsat své praktické zkušenosti pro osvícení davů. -->
<!-- np9:categoryId = 1 -->
<!-- x4w:category = Koně -->
<!-- np9:authorId = 1 -->
...
Kdybych takto někam pravidelně cestoval, pravděpodobně bych předplatné využíval a pořídil bych si 3G verzi.
