<!-- dcterms:identifier = aspnetcz#5417 -->
<!-- dcterms:title = Quo vadis ASP.NET? -->
<!-- dcterms:abstract = Protože se náš prezident k ulehčení národa rozhodl, že nebude mít novoroční projev, zbylo to na mne. A protože společenskou a politickou situaci bych musel hodnotit slovy, které se nehodí užívat ve slušné společnosti, budu se zabývat ASP.NET a tím, co nás čeká. V dobrém i zlém, v nastávajících verzích, v nastávajících letech. -->
<!-- np9:categoryId = 7 -->
