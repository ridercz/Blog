<!-- dcterms:identifier = riderweblog#1284 -->
<!-- dcterms:title = Čemu mne naučili českoslovenští vlčáci -->
<!-- dcterms:abstract = Dnes je tomu třináct let, co se narodila Esta Kanýčo, moje psí průvodkyně životem. Přišel jsem k ní tak trochu jako slepý k houslím a od té doby nikdy nezalitoval. A dost jsem se toho od ní a jejích jakovlčích kolegů naučil. -->
<!-- np9:categoryId = 3 -->
<!-- x4w:category = Vlci -->
<!-- np9:authorId = 1 -->
