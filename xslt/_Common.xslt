...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template name="PopulateHeader">
    ...
    <script src="/content/scripts/autocorrect.js?sha={x4h:ComputeHash('/content/scripts/autocorrect.js')}" defer="defer" onload="typo.runAutoCorrector({{number: false}})">//</script>
  </xsl:template>
